...
public class RepresentativeTests {
    ...
    private final String ACTIVITY = "com.boxed.v2.ui.account.setup.FtueActivity";
    private final String PACKAGE = "com.boxed.prod";
    ...
    public void testSignIn() {
        //transit
        AndroidElement zip = (AndroidElement) driver.findElementById("com.boxed.prod:id/zipCodeNewEditText");
        zip.click();
        AndroidElement signin_jump = (AndroidElement) driver.findElementById("com.boxed.prod:id/continueWithEmail_newFTUE");
        signin_jump.click();
    ...
    public void testSignUp() {
        ...
        AndroidElement zip = (AndroidElement) driver.findElementById("com.boxed.prod:id/zipCodeNewEditText");
        zip.sendKeys("90089");
        AndroidElement signup_jump = (AndroidElement) driver.findElementById("com.boxed.prod:id/continueWithEmail_newFTUE");
        signup_jump.click();

        //test
        AndroidElement email = (AndroidElement) driver.findElementById("com.boxed.prod:id/email");
        email.sendKeys(Configuration.email);
        AndroidElement password = (AndroidElement) driver.findElementById("com.boxed.prod:id/password");
        password.sendKeys("bbb");
        AndroidElement sign_up = (AndroidElement) driver.findElementById("com.boxed.prod:id/confirm_action");
        sign_up.click();
    }
